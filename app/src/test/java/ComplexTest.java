...
public class ComplexTest {
    ...
    public ComplexTest() throws DataException {
    ...
    public void testComplexDivision() throws Exception {
        assertEquals(math.division(new Complex(3, 4), (new Complex(2, 1))), new Complex(2, 1));
    }
    ...
    public void testComplexInverse() throws Exception {
        assertEquals(math.inverse(f), new Complex(-4, 5));
    }
...
//    }
    ...
    public void testGetStringComplex() {
        assertEquals(f.toString(), Double.valueOf(f.getWholePart()).toString() + " + i * " + Double.valueOf(f.getImaginaryPart()).toString());
        assertEquals(f2.toString(), Double.valueOf(f2.getWholePart()).toString() + " - i * " + (((-1) * f2.getImaginaryPart())));
    }
